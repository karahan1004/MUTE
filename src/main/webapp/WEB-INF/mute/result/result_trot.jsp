...
<body>
	...
	<table class="table1">
		<tr>
			<td><img alt="gom_trot" src="resources/images/gom_trot.png"
				height="500" width="500"></td>
		</tr>
		<tr>
			<td><a class="trot" style="color: #FF3232;">트로트를 좋아하는 당신은
					베리베리스트로베리!</a></td>
		</tr>
		<tr>
	...
	<div class="con">
		<div class="reco">
			<br> <a class="tag">당신을 위한 #트로트 음악</a><br>
			<br>
			<table class="table2">
				<tr>
