        ...
        <div class="reco">
            ...
            <table class="table2">
                <tr>
                    ...
                    <td><a id="toggleStar1" onclick="toggleModal('addModal'); toggleStar1()">
                ...
                <tr>
                    ...
                    <td><a id="toggleStar2" onclick="toggleModal('addModal'); toggleStar2();">
                ...
                <tr>
                    ...
                    <td><a id="toggleStar3" onclick="toggleModal('addModal'); toggleStar3();">
